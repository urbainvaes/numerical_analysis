...
# server set up.
c.CourseDirectory.course_id = "notebooks_nbgrader"
...
c.ClearSolutions.code_stub = {'julia': '# YOUR CODE HERE', 'python': '# YOUR CODE HERE\nraise NotImplementedError()', 'R': '# YOUR CODE HERE\nfail()', 'matlab': "% YOUR CODE HERE\nerror('No Answer Given!')", 'octave': "% YOUR CODE HERE\nerror('No Answer Given!')", 'sas': '/* YOUR CODE HERE */\n %notImplemented;', 'java': '// YOUR CODE HERE'}
...
c.InstantiateTests.comment_strs = {'ir': '#', 'python': '#', 'python3': '#', 'julia': '#'}
...
#  Default: {'ir': <function InstantiateTests.<lambda> at 0x798a7ef58220>, 'python': <function InstantiateTests.<lambda> at 0x798a7ef582c0>, 'python3': <function InstantiateTests.<lambda> at 0x798a7ef58360>}
# c.InstantiateTests.sanitizers = {'ir': <function InstantiateTests.<lambda> at 0x798a7ef58220>, 'python': <function InstantiateTests.<lambda> at 0x798a7ef582c0>, 'python3': <function InstantiateTests.<lambda> at 0x798a7ef58360>}
