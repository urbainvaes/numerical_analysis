...
It is available in most programming languages and based on the following reformulation of the problem:
renumber the nodes of an undirected graph in such a manner that the bandwidth of the corresponding adjacency matrix is minimum?
