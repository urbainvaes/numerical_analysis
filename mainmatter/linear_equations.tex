...
\end{theorem}
\begin{proof}
    Substituting the optimal step size~\eqref{eq:linear_optimal_step_size_steepest_descent} in~\eqref{eq:linear_steepest},
    we obtain
    \[
        f\bigl( \vect x^{(k)} \bigr) + \frac{\omega_k^2}{2} \vect d^\t \mat A \vect d - \omega_k \vect d^\t \vect b
    \]
\end{proof}
