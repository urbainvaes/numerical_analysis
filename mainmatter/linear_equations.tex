...
\begin{proof}
    ...
    \]
    Since the first and second factors on the right-hand side are respectively unit lower triangular and upper triangular,
    we deduce, by uniqueness of the $\mat L \mat U$ decomposition,
