...
\begin{compexercise}
    ...
    Implement a code for calculating the Cholesky factorization of a matrix by comparing the entries of the product $\mat C \mat C^\t$ with those of the matrix $\mat A$.
