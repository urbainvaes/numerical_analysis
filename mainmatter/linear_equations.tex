...
\begin{proof}
    ...
    and the other transformation matrices $\mat M_3, \dotsc, \mat M_{n-1}$ leave the third row invariant.
...
\begin{exercise}
    Write a computer algorithm for calculating the $\mat L \mat U$ decomposition of a square matrix $\mat A \in \real^{n \times n}$,
    ...
    \begin{itemize}
        \item
            ...
            \[
                \ell_{11} u_{1k} = a_{1k}.
            \]
            Since $\ell_{11} = 1$ as $\mat U$ is lower triangular,
            this gives $u_{1k} = a_{1k}$.
        ...
        \item
            Comparing the entry $(3, k)$ with $k \in \{3, \dotsc, n\}$ give
            \[
    ...
    \end{itemize}
    It is crucial, for this exercise,
    to first figure out the algorithm on paper,
