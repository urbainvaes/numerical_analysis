...
\label{ssub:criteria_for_convergence}

It is tempting to reason formally that
\[
    \mat M^{-1} \mat N
    = \mat M^{-1}(\mat M - \mat A)
    = (\mat I - \mat M^{-1} \mat A)
...
\begin{compexercise}
    ...
    \[
        ...
        h = \frac{1}{n}.
    \]
    Plot the norm of the residue as function of the iteration index in both cases.
\end{compexercise}
