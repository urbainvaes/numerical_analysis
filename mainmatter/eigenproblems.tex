...
the matrix $\mat X_k$ converges to a diagonal matrix with the eigenvalues of~$\mat A$ on the diagonal.
...
We then discuss a particular choice for the space $\mathcal U$ that is very useful in practice.
...
\[
    \mat P_{\mat U} \vect v := \mat U \mat U^* \vect v = (\vect u_1 \vect u_1^* + \dotsb + \vect u_p \vect u_p^*) \vect v.
\]
In practice,
...
\begin{equation}
    ...
    (\mat U^* \mat A \mat U) \vect z = \lambda \vect z.
\end{equation}
...
Of course, the eigenvalues of this problem are in general different from those of~$\mat A$.
