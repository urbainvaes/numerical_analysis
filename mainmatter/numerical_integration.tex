...
\paragraph{Construction of $(1 - \alpha)$ confidence interval.}
By definition,
a $(1 - \alpha)$ confidence interval for~$I$ is
an interval $[x_1, x_2]$ such that the probability that $I \in [x_1, x_2]$ is greater than or equal to~$1 - \alpha$.
...
\begin{compexercise}
    ...
    \end{minted}
            ...
            using a Monte Carlo approach with~$\julia{n}$ samples.
            Your function should return the estimated volume
