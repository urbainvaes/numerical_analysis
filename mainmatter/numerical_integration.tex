...
\begin{theorem}
    ...
    \begin{equation}
        ...
        \bigl\lvert I - \widehat I \bigr\rvert
...
\end{align*}
This formula is valid for any $\alpha \in A := [x_{2i}, x_{2i+2}] \backslash \{x_{2i}, x_{2i+1}, x_{2i+2}\}$.
...
\begin{proof}
    ...
    \[
        ...
        = \sum_{i=0}^{m} w_i \bigl\lvert \ell_j(x_i) \bigr\rvert^2 = w_j.
    \]
