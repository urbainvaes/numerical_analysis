...
Let us introduce the integer number $\widethat e = (e_0 e_1 \dots e_6 e_7)_2$;
...
\begin{itemize}
    ...
    \item
        ...
        which is usally an indication that something has gone wrong in the calculation.
\end{itemize}

\begin{exercise}
    Determine the encoding of the \texttt{Float32} number $x = 2^{E_{\min}}$.
\end{exercise}
