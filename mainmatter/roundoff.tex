...
Since the overflow behavior of integer format is not universal across programming languages,
...
\begin{solution}
    ...
    \begin{equation}
        ...
        \log(7) = (\underbrace{1.1111001000}_{\text{11 bits}}100111001010101110001100100101101001010111...)_2
    \end{equation}
    ...
    \[
        \exp(1.9462890625)
        = 2^2 (\underbrace{1.1100000000}_{\text{11 bits}}101011011101110000111000100001100010001110...)_2,
    \]
