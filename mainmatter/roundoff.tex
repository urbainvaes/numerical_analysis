...
The basic principles of rounding to a floating point format,
...
\begin{itemize}
    ...
    \item
        ...
        \]
        It is therefore not unreasonable that only 4 digits should be included in the decimal representation of half-precision numbers.
\end{itemize}
\end{remark}
...
\Cref{sec:set_of_values} is based on the 1985 IEEE 754 standard~\cite{ieee754} and on the reference book~\cite{MR2265914}.
The former reference presents a much more complete picture of the material than is possible the present in this chapter.
% In this chapters,
