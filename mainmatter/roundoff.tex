...
the action of approximating an infinitely precise real number by a number in a floating point format $\floating (p, E_{\min}, E_{\max})$.
...
the result delivered by the computer is the exact result of the operation,
