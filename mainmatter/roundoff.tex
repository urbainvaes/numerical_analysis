...
The left panel of~\cref{fig:float64} depicts the density of double-precision floating point numbers.
...
The right panel of~\cref{fig:float64} illustrates the relative spacing between successive floating point numbers,
in units of machine precision.
Although the absolute spacing increases with the absolute value of $x$,
the relative spacing oscillates between $f


(left panel) and the relative spacing between successive floating point (right panel)


\begin{figure}
    \label{fig:float64}%
    \includegraphics[width=.49\textwidth]{figures/float64_density.pdf}%
    \includegraphics[width=.49\textwidth]{figures/float64_spacing.pdf}%
    \caption{%
        \textbf{Left:} Density of the double-precision floating point numbers,
        ...
        \textbf{Right:} Relative spacing between successive double-precision floating point numbers.
    }%
\end{figure}
