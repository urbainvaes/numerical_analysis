...
\begin{exercise}
    ...
    \noindent \textbf{Remark:} It should not be inferred from this exercise that \julia{Float32(1/i) * i} is always exact in floating point arithmetic.
...
The values of the exponent and significand which are selected,
