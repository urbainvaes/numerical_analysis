...
\begin{compexercise}
    ...
    pows2 = 2 .^ range(0, length=length(bits))
...
\end{exercise}
\begin{solution}
    The exact binary representation of $\sqrt{2}$ is
    \begin{align*}
        \sqrt{2}
        &= (\underbrace{1.01101010000010011110011}_{\text{24 bits}}001100\dots)_2.
    \end{align*}
    The first task is to determine the member of $\floating_{32}$ that is nearest $\sqrt{2}$.
    We have
    \begin{align*}
