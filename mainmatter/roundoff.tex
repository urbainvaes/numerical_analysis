...
\begin{equation}
    ...
    x = \sum_{k=-n}^{\infty} a_k \beta^{-k}, \qquad 0 \leq a_k < \beta.
\end{equation}
The number $x$ may then be denoted as $(a_{-n} a_{-n+1}\dots a_{-1} a_{0}.a_{1} a_{2} \dots)_{\beta}$,
...
The following, whose proof is postponed to \cref{exercise:machine_epsilon},
establishes a link between the machine $\varepsilon_M$ and
...
\begin{exercise}
    ...
    Prove \cref{prop:uniqueness_standard_representation}.
\end{exercise}
