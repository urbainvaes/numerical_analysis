...
\begin{equation}
    \label{eq:ode}
    \dot {\vect x}(t) = \vect f\bigl(t, \vect x(t)\bigr), \qquad
    \vect x(t_0) = \vect x_0.
\end{equation}
...
\begin{corollary}
    [Maximal solutions]
    Assume that $f$ is continuous in~$t$ and satisfies the Lipschitz condition~\eqref{eq:local_lipschitz_uniqueness}.
