...
\end{definition}
Denoting by $\vect e_i$ the $i$-th column of $P$ and by $\lambda_i$ the $i$-th diagonal element of $D$,
...
a pillar of linear algebra which admits important generalizations to infinite-dimensional operators.
