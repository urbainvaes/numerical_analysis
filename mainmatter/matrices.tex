...
\begin{proof}
    ...
    Any $\vect x \in \mathcal X$ admits a unique representation in the basis as $\vect x = \lambda_1 \vect e_1 + \dotsb + \lambda_n \vect e_n$.
...
\begin{example}
    ...
    Indeed, assume by contradiction that there exists~$f_* \in C([-1, 1])$ such that
    \[
...
This approach is used in~\cref{lemma:linear_inverse_neumann} and~\cref{exercise:global_exponential_stability}.
