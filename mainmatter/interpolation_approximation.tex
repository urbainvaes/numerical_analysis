...
We begin, in \cref{sub:polynomial_regression} with a discussion of polynomial regression,
...
Consider $m + 1$ distinct $x$ values $x_0 < \dotsc < x_m$,
and suppose that we know the values taken by an unknown function $u$ when evaluated at these points.

\subsection{Mean square approximation}
