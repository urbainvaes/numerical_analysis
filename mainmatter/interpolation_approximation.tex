...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \frac 1 k \left(\frac 1 {(k - 1)!} \Delta^{k - 1} u(i + 1) - \frac 1 {(k - 1)!} \Delta^{k - 1} u(i)\right)\\
        &= \frac 1 k \left([u_{i + 1}, \dotsc, u_{i + k}] - [u_i, \dotsc, u_{i + k - 1}]\right).
    \end{align*}
    By our definition of divided differences in~\eqref{eq:definition_divided_difference},
