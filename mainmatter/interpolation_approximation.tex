...
we focus on \emph{function approximation},
...
more often than not, employing these nodes for interpolation produces much better results than using equidistant nodes,
