...
\begin{remark}
    ...
    is sufficient to derive an explicit expression for the polynomial~$T_n$,
...
For simplicity,
we assume in this section that only the values of the first derivative are specified.
Given data~$(x_i, u_i, u_i')$ for $i \in \{0, \dotsc, n\}$,
Hermite interpolation consists of finding a polynomial~$\widehat u$ of degree at most~$2n + 1$
such that
\[
    \forall i \in \{0, \dotsc, n\}, \qquad
