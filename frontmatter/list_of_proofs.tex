...
\begin{itemize}
    ...
    \item \Cref{proposition:linear_convergence} when given Gelfand's formula (convergence splitting methods).
...
\begin{itemize}
    \item \Cref{theorem:exponential_convergence_fixed_point} (global exponential convergence of the fixed point iteration).
    ...
    \item \Cref{theorem:newton_raphson_1d} (quadratic convergence of Newton--Raphson in dimension 1).
\end{itemize}
